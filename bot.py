...
#   ХРАНИЛИЩЕ
# ============================================================
keys = {}            # key -> {"expire": float, "user_id": int, "type": "free"/"paid"}
user_keys = {}       # user_id -> key
user_last_free = {}  # user_id -> timestamp последнего бесплатного ключа
waiting_support = {} # user_id -> True
owner_reply_to = {}  # OWNER_ID -> user_id
pending_purchase = {}# user_id -> {"step": str, ...}
owner_gen_state = {} # OWNER_ID -> {"step": str, ...}
